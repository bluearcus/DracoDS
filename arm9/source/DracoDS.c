...
void DisplayStatusLine(void)
{
    ...
    DSPrint(29,0,2, ((sam_registers.memory_map_type && sam_64k_mode_counter < 2) ? "32K": "64K"));
                          ...
                          else if (myConfig.keymap[i] >= 59)   // Macro mapping
                          {
                              switch (myConfig.keymap[i])
                              {
                                  case 59:
                                    ...
                                    break;
                                  case 60:
                                    BufferKey(5); BufferKey(49); BufferKey(16); BufferKey(48); BufferKey(255);   // ATTACK LEFT
                                    break;
                                  case 61:
